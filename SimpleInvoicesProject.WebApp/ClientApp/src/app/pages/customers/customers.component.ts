...
import {
  ...
  AlertMessage,
  MessageTypes
} from 'src/app/shared/components/alert-message/alert-message.component';
...
import {
  ...
  FormBuilderPropsSpec
} from 'src/app/shared/components/form-builder/form-builder.component';
